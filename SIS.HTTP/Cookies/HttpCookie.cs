...
namespace SIS.HTTP.Cookies
{
    public class HttpCookie
    {
        ...
        private const string HttpCookieDefaulthPath = "/";

        public HttpCookie(string key, string value,
            int expires = HttpCookieDefaulthExpirationDays,
            string path=HttpCookieDefaulthPath) : this(key,value,true,expires,path)
        {
        ...
        public HttpCookie(string key, string value,bool isNew,
            int expires = HttpCookieDefaulthExpirationDays,
            string path = HttpCookieDefaulthPath)
        {
